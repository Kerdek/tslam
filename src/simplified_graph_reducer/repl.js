import { highlight_html, read, to_digraph } from "./lang.js";
import { make, reduce } from "./graph.js";
(async () => {
  ...
  fill: var(--background); }`);
    ...
    const keep_steps = make_checkbox('keep_steps', 'Keep Steps');
    ...
    const dispatch = async () => {
        ...
        for (;;) {
            ...
            output_element.style.display = "inline-table";
            ...
            output_element.appendChild(await to_digraph("state", { '': state }));
