  ...
  fill: var(--background); }`);
    ...
    const debug_link = element('a', function () {
        ...
        this.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!d)
                return;
            yield new Promise(cb => d.addEventListener('load', cb));
    ...
    const replace_text = content => {
        ...
        if (window.getSelection) {
            ...
            if (y.startContainer === system) {
                const t = ((_a = system.childNodes[0]) === null || _a === void 0 ? void 0 : _a.textContent) || '';
    ...
    output.addEventListener('keydown', (e) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (program) {
            ...
            for (;;) {
                ...
                if (io.kind === 'app') {
                    ...
                    if (io.sym === sleepId) {
                        io = (yield new Promise(cb => wakeHandler = cb));
                    }
