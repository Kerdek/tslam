				...
				<Container fluid>
					...
					<Navbar.Collapse id="basic-navbar-nav" role="">
						<Nav className="me-auto">
							...
							<Nav.Link active={playground.isActive} href={playground.href}>
								Playground
							</Nav.Link>
							<Nav.Link active={monarch.isActive} href={monarch.href}>
								Monarch
							</Nav.Link>
						...
						<Nav className="ms-auto">
							<NavDropdown title={<>
									...
									</>} className="download-dropdown" align="end">
								{/*<NavDropdown.Item href="#action/3.1">
                Download 0.33.0
        </NavDropdown.Item>*/}
								<NavDropdown.Item href="https://www.npmjs.com/package/monaco-editor" target="_blank">
									Get From NPM
								</NavDropdown.Item>
							</NavDropdown>

							<Nav.Link href="https://github.com/microsoft/monaco-editor" target="_blank">
