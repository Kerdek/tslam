...
async function initialize(state) {
    ...
    try {
        ...
        pre.appendChild(document.createTextNode(`${err}: ${err.state}`));
...
globalThis.$sendMessageToParent = sendMessageToParent;
globalThis.$bindModelToCodeStr = function bindModel(model, codeStringName) {
