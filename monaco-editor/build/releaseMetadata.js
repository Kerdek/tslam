...
function getBasicLanguages() {
    return new Promise((resolve, reject) => {
        glob('./out/monaco-editor/esm/vs/basic-languages/*/*.contribution.js', { cwd: path.dirname(__dirname) }, (err, files) => {
            if (err) {
                reject(err);
                return;
            }
...
function readAdvancedLanguages() {
    return new Promise((resolve, reject) => {
        glob('./out/monaco-editor/esm/vs/language/*/monaco.contribution.js', { cwd: path.dirname(__dirname) }, (err, files) => {
            if (err) {
                reject(err);
                return;
            }
