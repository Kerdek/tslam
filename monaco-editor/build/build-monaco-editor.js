...
(() => {
    ...
    otherFiles = otherFiles.concat(readFiles('node_modules/monaco-editor-core/min-maps/**/*', {
        base: 'node_modules/monaco-editor-core/'
    }));
    otherFiles = otherFiles.concat(readFiles('node_modules/monaco-editor-core/LICENSE', {
        base: 'node_modules/monaco-editor-core/'
    }));
    ...
    for (const file of files) {
        ...
        const extraContent = pluginFiles.map((file) => {
            return file.contents
                .toString()
                .replace(/define\((['"][a-z\/\-]+\/fillers\/monaco-editor-core['"]),\[\],/, "define($1,['vs/editor/editor.api'],");
        });
...
//# sourceMappingURL=build-monaco-editor.js.map